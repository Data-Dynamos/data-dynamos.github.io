...
In this exercise, you will create a view that combines the results of the `co2_emissions_by_country` table and the `aggregate_country_temperatures` table. You will perform an INNER JOIN between these two tables and standardize the country name using the `initcap` function.
